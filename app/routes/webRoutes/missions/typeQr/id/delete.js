// app/routes/webRoutes/missions/typeQr/id/delete.js
 ...
 *     tags:
 *       - Missions
 *     summary: Delete a QR code-based mission
 *     description: |
 *       Soft-deletes a mission of type 'QR_CODE'.
 ...
 */
const deleteQrMission = async (req, res, next) => {
    const { id } = req.params;
    ...
    try {
        ...
        const missionCheck = await client.query("SELECT id FROM missions WHERE id = $1 AND type = 'QR_CODE' AND deleted_at IS NULL", [id]);
...
module.exports = deleteQrMission;
