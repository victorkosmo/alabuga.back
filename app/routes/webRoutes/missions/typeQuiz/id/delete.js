// app/routes/webRoutes/missions/typeQuiz/id/delete.js
 ...
 *     tags:
 *       - Missions
 *     summary: Delete a quiz-based mission
 *     description: |
 *       Soft-deletes a mission of type 'QUIZ'.
 ...
 */
const deleteQuizMission = async (req, res, next) => {
    const { id } = req.params;
    ...
    try {
        ...
        const missionCheck = await client.query("SELECT id FROM missions WHERE id = $1 AND type = 'QUIZ' AND deleted_at IS NULL", [id]);
...
module.exports = deleteQuizMission;
