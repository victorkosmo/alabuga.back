// app/routes/webRoutes/campaigns/id/achievements/list.js
 ...
 *     tags:
 *       - Achievements
 *     summary: List achievements for a campaign
 *     description: Retrieve a paginated list of achievements for a specific campaign.
 *     security:
 *       - bearerAuth: []
 *     parameters:
 *       - in: path
...
const listAchievements = async (req, res, next) => {
    try {
        ...
        res.locals.message = 'Achievements for campaign retrieved successfully.';
        next();
